...
from accounts.permissions import IsAdmin, IsAdminOrCourier, IsAdminOrDirector, IsAdminOrDirectorOrAccountant
...
class DriverViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        if self.action in ['list', 'retrieve']:
            return [IsAdminOrCourier() | IsAdminOrDirectorOrAccountant()]
        return [IsAdmin()]
...
class DriverPaymentViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    permission_classes = [IsAdminOrCourier | IsAdminOrDirectorOrAccountant]
